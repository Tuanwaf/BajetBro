...
// `rainbow` makes it cycle through hues (Legend).
export const TIERS = [
  ...
  { min: 150, max: Infinity, img: tier5, name: 'Legend', color: '#b37bff', pastel: 'linear-gradient(135deg, #ffe9f6 0%, #eae6ff 50%, #dff4ff 100%)', fire: ['#ffffff', '#9a7bff', '#ff4fc8'], rainbow: true },
];
